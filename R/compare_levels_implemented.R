...
# Tous ces appels devraient maintenant fonctionner :
compare_levels(df, value, by = group) # default
compare_levels(df, value, by = group, comparison = "revpairwise") 
compare_levels(df, value, by = group, comparison = "pairwise")
